...
## Estado: servidor instalado, pantallas pendientes de publicación para pruebas

Aplicadas al proyecto correcto las migraciones `20260916004238_agenda_booking_core.sql`, `20260916004248_agenda_worker_schedule.sql` y `20260916004412_agenda_slot_location_index.sql`. Archivos locales alineados con las versiones asignadas por Supabase remoto. Función `agenda` desplegada, versión 1. Las pantallas todavía no están publicadas en Vercel; el usuario autorizó publicarlas para pruebas sin incluir cambios ajenos de Landing. No se ha enviado correo real ni creado un evento de Google.
...
7. Conectar el remitente con consentimiento real y Calendar con selección de calendarios (el de escritura debe estar también en los consultados). No confundir esto con el acceso con Gmail existente.
...
- Advisors remotos leídos antes de desplegar: incidencias preexistentes ajenas a Agenda; no se modificaron otros módulos para resolverlas. Repetir después de aplicar Agenda y atender hallazgos nuevos.
