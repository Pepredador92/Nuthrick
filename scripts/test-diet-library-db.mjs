...
const estimates = readFileSync(new URL('../supabase/migrations/20260915230211_estimate_system_library_diets.sql', import.meta.url), 'utf8').replace(/^begin;\s*/im,'').replace(/commit;\s*$/i,'');
const estimateChecks = readFileSync(new URL('./test-library-estimates.sql', import.meta.url), 'utf8');
