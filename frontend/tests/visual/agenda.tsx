...
createRoot(document.getElementById('root')!).render(<MemoryRouter initialEntries={[window.location.search.includes('profile')?'/p/prueba':'/p/prueba/agendar']}><Routes><Route path="/p/:slug" element={<PublicProfilePage/>}/><Route path="/p/:slug/agendar" element={<PublicBookingPage/>}/><Route path="/p/:slug/agendar/datos" element={<PublicBookingPage/>}/></Routes></MemoryRouter>);
