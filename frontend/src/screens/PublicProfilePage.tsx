...
export function PublicProfilePage() {
  ...
  return <main className="min-h-screen overflow-x-hidden bg-[#f7f8f4] text-[#17312c]">
    ...
    <div className="mx-auto w-full max-w-7xl min-w-0 px-5 pb-20 pt-8 sm:px-8">
      ...
      <nav aria-label="Secciones del perfil" className="mt-4 flex min-w-0 gap-2 overflow-x-auto rounded-2xl border border-[#dfe7e1] bg-white/80 p-2 shadow-sm">
        {profile.biography && <a href="#sobre-mi" className="min-h-11 shrink-0 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#456d5e] transition hover:bg-[#edf4ef]">Sobre mí</a>}
        {profile.specialties.length > 0 && <a href="#especialidades" className="min-h-11 shrink-0 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#456d5e] transition hover:bg-[#edf4ef]">Especialidades</a>}
        {(profile.conditions.length > 0 || profile.populations.length > 0) && <a href="#enfoque" className="min-h-11 shrink-0 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#456d5e] transition hover:bg-[#edf4ef]">Enfoque</a>}
        {profile.gallery.some((item) => item.url) && <a href="#galeria" className="min-h-11 shrink-0 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#456d5e] transition hover:bg-[#edf4ef]">Galería</a>}
        {(hasBusinessDetails || locations.length > 0) && <a href="#ubicaciones" className="min-h-11 shrink-0 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#456d5e] transition hover:bg-[#edf4ef]">Ubicaciones</a>}
        {profile.education.length > 0 && <a href="#educacion" className="min-h-11 shrink-0 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#456d5e] transition hover:bg-[#edf4ef]">Formación</a>}
        {profile.spokenLanguages.length > 0 && <a href="#idiomas" className="min-h-11 shrink-0 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#456d5e] transition hover:bg-[#edf4ef]">Idiomas</a>}
        <a href="#agendar" className="ml-auto min-h-11 shrink-0 rounded-xl bg-[#173d36] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#245348]">Reservar una cita</a>
      </nav>
      </div>
