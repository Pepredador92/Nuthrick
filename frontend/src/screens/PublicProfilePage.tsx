...
export function PublicProfilePage() {
  ...
  return <main className="min-h-screen overflow-x-hidden bg-[#f7f8f4] text-[#17312c]">
    <header className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-5 py-6 sm:px-8"><Logo /><Link to="/register" className="text-right text-sm font-semibold text-[#496e61]">¿Eres nutriólogo? Crea tu perfil</Link></header>
