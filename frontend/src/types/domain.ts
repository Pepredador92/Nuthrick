...
export interface ConsultationSnapshot { id: string; professional_id: string; consultation_id: string; patient_id: string; template_id: string | null; template_name: string; template_version: number; structure: ConsultationSnapshotStructure; created_at: string; }
...
export interface ConsultationAnswer { id: string; professional_id: string; consultation_id: string; patient_id: string; question_key: string; section_key: string; response_area: ConsultationResponseArea; value: unknown; created_at: string; updated_at: string; }
