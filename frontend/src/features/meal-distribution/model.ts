...
const groupMealWeights: Partial<Record<ExchangeGroupCode, Partial<Record<MealType, number>>>> = {
  VEGETABLES: { BREAKFAST: 0.7, SNACK: 0.08, MAIN_MEAL: 1.45, DINNER: 1.25, CUSTOM: 0.75 },
  FRUITS: { BREAKFAST: 1.2, SNACK: 0.4, MAIN_MEAL: 0.8, DINNER: 0.75, CUSTOM: 0.85 },
  CEREALS_NO_FAT: { BREAKFAST: 1.25, SNACK: 0.25, MAIN_MEAL: 1.35, DINNER: 1.2, CUSTOM: 0.9 },
  CEREALS_WITH_FAT: { BREAKFAST: 1, SNACK: 0.2, MAIN_MEAL: 1.15, DINNER: 1, CUSTOM: 0.8 },
  LEGUMES: { BREAKFAST: 0.8, SNACK: 0.05, MAIN_MEAL: 1.35, DINNER: 1.15, CUSTOM: 0.65 },
  AOA_VERY_LOW_FAT: { BREAKFAST: 0.75, SNACK: 0.05, MAIN_MEAL: 1.45, DINNER: 1.25, CUSTOM: 0.75 },
  AOA_LOW_FAT: { BREAKFAST: 0.75, SNACK: 0.05, MAIN_MEAL: 1.45, DINNER: 1.25, CUSTOM: 0.75 },
  AOA_MODERATE_FAT: { BREAKFAST: 1.05, SNACK: 0.05, MAIN_MEAL: 1.25, DINNER: 1.2, CUSTOM: 0.7 },
  AOA_HIGH_FAT: { BREAKFAST: 0.6, SNACK: 0.05, MAIN_MEAL: 1.25, DINNER: 1.15, CUSTOM: 0.65 },
  MILK_SKIM: { BREAKFAST: 1.4, SNACK: 0.3, MAIN_MEAL: 0.15, DINNER: 0.6, CUSTOM: 0.85 },
  MILK_SEMI_SKIM: { BREAKFAST: 1.4, SNACK: 0.3, MAIN_MEAL: 0.15, DINNER: 0.6, CUSTOM: 0.85 },
  MILK_WHOLE: { BREAKFAST: 1.35, SNACK: 0.3, MAIN_MEAL: 0.15, DINNER: 0.6, CUSTOM: 0.8 },
  MILK_WITH_SUGAR: { BREAKFAST: 1.2, SNACK: 0.25, MAIN_MEAL: 0.1, DINNER: 0.5, CUSTOM: 0.75 },
  FATS_NO_PROTEIN: { BREAKFAST: 0.8, SNACK: 0.15, MAIN_MEAL: 1.25, DINNER: 1.05, CUSTOM: 0.75 },
  FATS_WITH_PROTEIN: { BREAKFAST: 0.85, SNACK: 0.2, MAIN_MEAL: 1.1, DINNER: 1, CUSTOM: 0.8 },
